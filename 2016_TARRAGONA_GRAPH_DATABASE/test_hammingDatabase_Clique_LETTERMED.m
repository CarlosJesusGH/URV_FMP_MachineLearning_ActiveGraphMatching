...
% [hamming_LETTERMED_no_learn,~,~] = hammingDatabase_Clique_nD('LETTERMED',w,attributes,Kv,Ke,Num_Registers)
%%
...
[hamming_LETTERMED,~,~] = hammingDatabase_Clique('LETTERMED',Kv,Ke,Num_Registers);
%%
...
[hamming_LETTERMED_nD,~,~] = hammingDatabase_Clique_nD('LETTERMED',w,attributes,Kv,Ke,Num_Registers);
%%
clear w;
clear Kv;
clear Ke;
