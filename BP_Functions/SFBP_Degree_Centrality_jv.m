function [distance,lab]=SFBP_Degree_Centrality_jv(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
% francesc.serratosa@urv.cat
% [Distance,labelling]= SFBP_Degree_Centrality_jv(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
