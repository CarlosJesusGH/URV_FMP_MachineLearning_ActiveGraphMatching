function [distance,lab]=BP_Degree_Centrality_h_Palmprint(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
% francesc.serratosa@urv.cat
% [Distance,labelling]= BP_Degree_Centrality_h(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
