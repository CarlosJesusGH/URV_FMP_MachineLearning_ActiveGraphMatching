function [average_accuracy,average_runtime,accuracy] = classifyDatabase_Clique_nD(databaseName,w,attributes,KV,KE,num_test_graphs)
        ...
        for j = 1:length(Database.Learning)
            ...
            switch databaseName
                case 'LETTERLOW'
                    ...
                    tic
                    [cost,~] = BP_Clique_Centrality_h_nD(NA,NB,EA,EB,w,attributes,KV,KE);
                    runtime=toc;
%                     runtime
