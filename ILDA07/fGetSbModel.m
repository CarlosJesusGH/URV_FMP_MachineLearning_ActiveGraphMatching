function [meanVector, noOfSample, eigenVectors, eigenValues, samplePerClass, meanPerClass] = fGetSbModel(featureVectorInCol, featureLabel, eigenThreshold)
% -----------------------------------------------------------------------
...
%     aux = featureVectorInCol(:,classIndex)
    aux = featureVectorInCol(classIndex,:)
    classMean = mean(aux,2);
