...
Database='LETTERLOW'; outlier=5; Selected_Registers= 1:1:750; attributes = 1:2;
...
Database='LETTERMED'; outlier=5; Selected_Registers= 1:1:750;attributes = 1:2;
...
figure(3);
Database='LETTERHIGH'; outlier=5; Selected_Registers= 1:1:750;attributes = 1:2;
...
Database='ROTATIONZOOM'; outlier=5; Selected_Registers= 1:3:20; attributes = 3:66;
