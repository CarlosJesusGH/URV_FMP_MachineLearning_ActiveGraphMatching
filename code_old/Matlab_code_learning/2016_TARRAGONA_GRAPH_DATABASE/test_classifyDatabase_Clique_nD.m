...
% [classify_ROTATIONZOOM,runtime_ROTATIONZOOM,class_ROTATIONZOOM] = classifyDatabase_Clique_nD('ROTATIONZOOM',w,attributes,Kv,Ke,0);

display('PALMPRINT');
w=w_PALMPRINT; Kv=Kv_PALMPRINT; Ke=Ke_PALMPRINT; attributes=1:5;
tic
[classify_PALMPRINT,runtime_PALMPRINT,class_PALMPRINT] = classifyDatabase_Clique_nD('PALMPRINT',w,attributes,Kv,Ke,1);
toc

save Results_Classify_Clique_nD;