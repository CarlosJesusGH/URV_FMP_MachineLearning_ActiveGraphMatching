function [average_accuracy,average_runtime,errors] = hammingDatabase_Point(databaseName,KV,num_test_graphs)
            ...
            if (j ~= i)
                ...
                switch databaseName
                    case 'LETTERLOW'
                        ...
                        tic
                        [~,automaticMapping] = BP_Points_Centrality_h(NA,NB,KV);
                    ...
                    case 'HOUSEHOTEL'
                        ...
                        tic
                        [~,automaticMapping] = BP_Points_Centrality_h_Features(NA,NB,KV);
                        errors(end + 1) = 1-(length(find(automaticMapping - idealMapping) ~= 0) / length(automaticMapping));
                        runtime=toc;
                    ...
                    case 'PALMPRINT'
                        ...
                        tic
                        [~,automaticMapping] = BP_Points_Centrality_jv_Palmprint(NA,NB,KV);
                        errors(end + 1) = (length(find(automaticMapping - idealMapping) ~= 0) / length(automaticMapping));
                        runtime=toc;
