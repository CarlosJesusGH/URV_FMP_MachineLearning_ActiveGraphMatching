function [average_accuracy,average_runtime,accuracy] = classifyDatabase_Clique(databaseName,KV,KE,num_test_graphs)
        ...
        for j = 1:length(Database.Learning)
            ...
            switch databaseName
                case 'LETTERLOW'
                    ...
                    tic
                    [cost,~] = BP_Clique_Centrality_h(NA,NB,EA,EB,KV,KE);
                    runtime=toc;
%                     runtime
...
%                     number_of_test
                ...
                case 'HOUSEHOTEL'
                    ...
                    EB = G2.Edges;
                      ...
                      tic
                    [cost,~] = BP_Clique_Centrality_h_Features(NA,NB,EA,EB,KV,KE);
                    runtime=toc;
%                     runtime
                    total_runtime=total_runtime+runtime;
                    number_of_test=number_of_test+1;
...
%                     number_of_test
                ...
                case 'PALMPRINT'
                    ...
                    tic
                    [cost,~] = BP_Clique_Centrality_jv_Palmprint(NA,NB,EA,EB,KV,KE);
                    runtime=toc;
%                     runtime
                    total_runtime=total_runtime+runtime;
                    number_of_test=number_of_test+1;
