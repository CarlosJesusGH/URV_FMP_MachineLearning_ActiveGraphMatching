function Features_Distance=Compute_Features_Distance(AA,BB)

% Normalize features
[AA, BB] = normalizeFeatures(AA, BB);
Features_Distance = metricSSD(AA, BB);
end
%==========================================================================
% Generate correspondence metric matrix using Sum of Squared Differences
%==========================================================================
function scores = metricSSD(features1, features2)
...
for c = 1:N1
    for r = 1:N2
        scores(c, r) = sum((features1(c,1:vector_length) - ...
            features2(r,1:vector_length)).^2);
    end
end
end
