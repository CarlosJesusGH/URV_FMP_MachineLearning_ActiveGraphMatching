function [distance,lab]=BP_Planar_Centrality_jv(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
% francesc.serratosa@urv.cat
% [Distance,labelling]= BP_Planar_Centrality_jv(NA,NB,EA,EB,NodeInsDel,ArcInsDel)
