function cost = Edit_Cost(AA,BB,A,B,NodeInsDel,ArcInsDel,lab)
...
%Insert Nodes
Not_Considered=sum((lab<0)); % If the labelling is not complete
%cost=cost+NodeInsDel*(sum(nul_b)-Not_Considered);
...
if(Not_Considered==0) %Insert Edges if the labelling is complete
