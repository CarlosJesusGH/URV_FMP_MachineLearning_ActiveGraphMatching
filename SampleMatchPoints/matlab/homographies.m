function [camNum,H,camPos,point3D,matched]=Homographies(keyPoints)
...
%take the first bestkeypoint to adapte
MaximumKeyPoint=bestKeypoint(1,:);

%changes keypoints
keypointChanged=auto_change(keyPoints,MaximumKeyPoint,1);
...
coordinatorChanges(NI,ind,MaximumKeyPoint,keypointChanged,...
